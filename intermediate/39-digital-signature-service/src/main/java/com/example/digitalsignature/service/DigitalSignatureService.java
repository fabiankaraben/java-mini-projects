...
public class DigitalSignatureService {
    ...
    public String sign(String data, String privateKeyStr) throws Exception {
    ...
    public boolean verify(String data, String signatureStr, String publicKeyStr) throws Exception {
